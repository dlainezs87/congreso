        ...
        <div class="row">
            ...
            <?php
                if($row['foto']!=""){?>
                    ...
                    <img src="<?= base_url ?>assets/img/expositores/<?php echo $row['foto']?>" width="100px" alt="Img Expositor" id="foto">
            <?php } ?>
            </div>
            <div class="col-6 form-group">
            <?php
                if($row['bandera']!=""){?>
                    ...
                    <img src="<?= base_url ?>assets/img/expositores/<?= $row['bandera']?>" width="100px" alt="Img Bandera" id="bandera">
            <?php } ?>
            </div>
        </div>
