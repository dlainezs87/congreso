      ...
      <div class="container-fluid" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-6" data-aos="zoom-in" data-aos-delay="100">
            <div class="align-items-stretch video-box" style='background-image: url("assets/img/why-us.jpg");margin-top:50px;'>
            </div>
          </div>

          <div class="col-lg-6 d-flex flex-column justify-content-center align-items-stretch">
            <div class="content">
              <h3 style="color:black;">Eum ipsam laborum deleniti <strong>velit pariatur architecto</strong></h3>
              <p>
